# uniflow-ai-conventions

## Purpose

Human and AI agent conventions: Cursor/AGENTS rules, workflow templates, and runnable YAML examples that enforce YAML-first orchestration discipline.
