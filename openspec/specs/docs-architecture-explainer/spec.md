# docs-architecture-explainer

## Purpose

VitePress architecture narrative: two-layer model, execution pipeline, Layer4 counterfactuals, module 3W pages, and design longform appendix.
