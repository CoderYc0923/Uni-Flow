        ...
        '/guide/': [
          {
            ...
            items: [
              ...
              { text: '跨项目复用', link: '/guide/cross-project' },
              { text: 'uses 与插件', link: '/guide/uses' },
              { text: '跨语言（手段）', link: '/guide/cross-lang' },
            ],
          },
        ],
        '/examples/': [
          {
            ...
            items: [
              ...
              { text: '跨项目 Unit', link: '/examples/workflow-as-unit' },
              { text: '跨语言 greeter', link: '/examples/cross-lang' },
            ],
          },
        ],
        '/reference/': [
